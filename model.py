...
class Task(BaseModel):
    user_id = CharField(default="", max_length=64, index=True)
    user_nick = CharField(default="", max_length=200)
    chat_id = CharField(default="", max_length=100, index=True)
    message_id = CharField(default="", max_length=100, index=True)
    chat_type = CharField(default="2", max_length=20, index=True) # 2 group 1 p2p
    track_id = CharField(default="", max_length=64, index=True)
